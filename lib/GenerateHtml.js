...
<body>
    ...
    <!-- First Coloumn -->
            <div class="col-lg-3 col-md-3 col-sm-12 d-flex justify-content-around flex-wrap">
                ${cardMaker(manArr)}
        </div>

    <!-- Second Column -->
    <div class="col-lg-6 col-md-5 col-sm-12 d-flex justify-content-around flex-wrap">
    ${cardMaker(engArr)}
        </div>
